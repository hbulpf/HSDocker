...
kubectl delete -f redis-slave.yaml -n $NS
kubectl delete -f redis-master.yaml -n $NS
kubectl delete -f ./nfs/
#create resources
kubectl create -f ./nfs/
kubectl create -f redis-master.yaml -n $NS
kubectl create -f redis-slave.yaml -n $NS
