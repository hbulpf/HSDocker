...
kubectl delete -f mahout-slave.yaml -n $NS
kubectl delete -f mahout-master.yaml -n $NS
#create resources
kubectl create -f mahout-master.yaml -n $NS
kubectl create -f mahout-slave.yaml -n $NS
